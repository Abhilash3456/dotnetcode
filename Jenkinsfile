        ...
        stage('Build + SonarQube analysis') {
            steps {
                withSonarQubeEnv('sonarqube-9.5') {
                    bat 'C:/Program Files/Microsoft Visual Studio/2022/Community/Msbuild/Current/Bin/MSBuild.exe begin /k:"sonartoken" /d:sonar.login="squ_272c063edcf9b0f25527b54fbcec3ad044d70de0"'
